...
def Field_instance_vars_assign_function():
...
def Field_instance_initialize_function():
...
def Field_instance_vars_print_function():
    ...
    print(Field35.name, Field35.color, Field35.price, Field35
    .owner)
...
Field_instance_vars_assign_function()
Field_instance_initialize_function()
Field_instance_vars_print_function()
##############################################################################
##############################################################################
##############################################################################
